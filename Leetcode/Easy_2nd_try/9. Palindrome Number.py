...
#   - It would be useful to know the full reverse with no strings method, my
#     attempt is below:
#
# def isPalindrome(self, x: int) -> bool:
#     # Time: O(d), d = number of digits in x
...
#     return x == rev
#
#   - Additionally, it would also be useful to know the string with two
#     pointers method, my attempt is below:
#
# def isPalindrome(self, x: int) -> bool:
#     # Time: O(d), d = number of digits in x
