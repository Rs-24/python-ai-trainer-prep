...
# Total space, including output, excluding input: worst case O(n) if linked
# list has no duplicates

# Learning lessons (done after completing all of above in 33 mins):
#   - Total space, including output, excluding input should actually be O(1)
#     because the output structure is still the input structure, just with
